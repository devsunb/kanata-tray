...
func (r *Runner) Run(ctx context.Context, presetName string, kanataExecutable string, kanataConfig string, tcpPort int, hooks config.Hooks, extraArgs []string, sudo bool) error {
	...
	err := instance.RunNonblocking(ctx, kanataExecutable, kanataConfig, tcpPort, hooks, extraArgs, sudo)
	if err != nil {
